...
export const addWishlistDB = createAsyncThunk(
  ...
  async (product, { getState, rejectWithValue }) => {
    try {
      ...
      // Agar url poora nahi hai toh port specify karein 'https://veloura-ai-mern-ecommerce\.vercel\.app//api/wishlist'
      const { data } = await axios.post("https://veloura-ai-mern-ecommerce.vercel.app/api/wishlist", { productId: product._id }, config);
